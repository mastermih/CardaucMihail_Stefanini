...
public class OrderProductDaoImplTest {
    ...
    void testInsert() throws SQLException {
        OrderProduct orderProduct = new OrderProduct(
                new Order(new Id(1L), null, Status.NEW, new CreateDateTime(LocalDateTime.now()), new UpdateDateTime(LocalDateTime.now())),
...
//    private void clearOrderProducts() throws SQLException {
